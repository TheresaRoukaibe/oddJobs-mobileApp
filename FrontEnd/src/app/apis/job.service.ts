...
export class JobService {
  ...
  get_who_applied_for_user(id: string){
    const response = this.http.get(this.base_url + "get_my_applicants.php/?id=" + id);
    return response;
  }
...
"job_id": job_id,
"user_id" : user_id,
"user_hired_id" : user_hired_id
    }
     const response = this.http.post(this.base_url + "hire.php", body, options);
